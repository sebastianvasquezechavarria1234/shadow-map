...
function createScene() {
    ...
    gltfloader.load('https://threejs.org/examples/models/gltf/Horse.glb', function (gltf) {
    ...
    gltfloader.load('https://threejs.org/examples/models/gltf/Stork.glb', function (gltf) {
        const mesh = gltf.scene.children[0];
        const clip = gltf.animations[0];
        addMorph(mesh, clip, 350, 1, 500 - Math.random() * 500, FLOOR + 350, 340);
    });

    gltfloader.load('https://threejs.org/examples/models/gltf/Parrot.glb', function (gltf) {
        const mesh = gltf.scene.children[0];
        const clip = gltf.animations[0];
